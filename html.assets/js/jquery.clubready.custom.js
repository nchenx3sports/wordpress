(function($){
    //Wrap in ready event so we can bind to elements when everything is loaded.
    $(document).on("ready", function() {
        ...
        var ClubReadyAPI = {
            ...
            var deferred = $.Deferred();
            deferred.resolve([{ Id: 47619, Name: "Internet Ad" }, { Id: 14881, Name: "Local Event" }, { Id: 15839, Name: "Facebook" }, { Id: 36625, Name: "Twitter" }, { Id: 36626, Name: "Instagram" }, { Id: 39505, Name: "Email" }, { Id: 15240, Name: "X3 Employee or Member" }, { Id: 15228, Name: "Friend (Non-Member)" },{Id: 14883, Name: "Other" } ]);
            return deferred;
            },
